             ...
             if(/textbox/i.test(cfg.notify)) {
                    if(isset(answer.errors)) {
                        ...
                        $.each(answer.infos, function(k,val) {
                            $.jGrowl(val, {theme: 'infos', header: 'ВНИМАНИЕ!', life: 6000 });
                        });
                    }
...
/**
 * ќбработчик кнопки форм.
 *  нопка должна быть внутри тегов <form> c классом .feedback
...
/*
     FILE ARCHIVED ON 19:59:36 Oct 09, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:56:28 Feb 22, 2018.
